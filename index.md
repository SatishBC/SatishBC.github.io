...
📍 Bengaluru, India | ✉️ sanathsatish@gmail.com 
🔗 [LinkedIn](https://linkedin.com/in/satishbc) | 🐙 [GitHub Profile](https://github.com/SatishBC)

---

## 🚀 About Me
Aspiring Data Analyst with an NIT Karnataka engineering background and full-time corporate exposure. Deeply passionate about transforming fragmented, messy raw data into scalable Star Schema models, automated financial metrics, and interactive executive trackers that eliminate operational delays. 

---

## 🛠️ Technical Expertise
* **Languages & Querying:** SQL (PostgreSQL, MySQL), Python (Pandas, NumPy)
* **Business Intelligence:** Power BI (Advanced DAX, Power Query, Data Modeling), Advanced Excel
* **Data Engineering:** ETL Pipelines, Relational Database Architecture, Data Validation & Cleaning

---

## 🏆 Featured Projects

### 1. Omnichannel Revenue & Vendor Settlement System (Power BI & SQL)
* **Business Problem:** A high-growth D2C Beauty brand faced severe data fragmentation across direct website ERP downloads, Nile YTD streams, and DCart (Scheduled & Quick Commerce) platforms, creating a 5–6 day manual reporting lag for vendor payouts.
* **Technical Solution:** Engineered an automated, scalable ETL pipeline using Power Query to ingest disparate channel formats smoothly. Authored time-bound contextual DAX measures to dynamically map product costs against active contract windows, integrating a dynamic 150-unit monthly volume discount trigger.
...
* **Links:** 🔗 [View Code Repository](https://github.com/SatishBC/Executive-Sales-Dashboard-PowerBI) | 📊 [Launch Live Interactive Dashboard](#)
...
* **Data Base Management Systems (DBMS)** – NPTEL, IIT Kharagpur

---

## 🎓 Education
* **Bachelor of Technology (B.Tech) – Civil Engineering** | NIT Karnataka, Surathkal
